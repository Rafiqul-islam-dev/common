                   ...
                   <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                            ...
                            <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="{{route('teacher.edit', $row->id)}}"><i class="ri-pencil-line"></i></a>
                               <a id="delete" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="{{route('teacher.delet', $row->id)}}"><i class="ri-delete-bin-line"></i></a>
                            </div>
                         </td>
                    </tr>
                    @endforeach
                    ...
                    @csrf
                      <div class="form-row">
                         ...
                         <div class="col-md-12 mb-3">
                            ...
                            <input type="date" class="form-control" name="joiningDate" id="validationTooltipUsername" >
                         </div>
