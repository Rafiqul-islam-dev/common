        ...
        <div class="iq-card">
              <div class="iq-card-header d-flex justify-content-between">
                 <div class="iq-header-title">
                    <h4 class="card-title">Class Routine <b>{{$clasid->classNameEnglish}}</b></h4>
                 </div>
              </div>
               ...
               <div id="table" class="table-editable">
                 ...
                 <table id="example" class="table table-bordered table-responsive-md table-striped text-center">
                   ...
                   <tbody>
                     ...
                     @foreach ($classroutine as $kye => $User )


                     <tr>
                        <td>{{$kye+1}}</td>
                        <td>{{$User->subject}}</td>
                        <td>{{$User->documentFile}}</td>
                        <td>
                           <div class="flex align-items-center list-user-action">
                              {{-- <a data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href=""><i class="ri-pencil-line"></i></a> --}}
                              <a id="delete" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete" href="{{route('classRoutine.delet', $User->id)}}"><i class="ri-delete-bin-line"></i></a>
                           </div>
                        </td>
                     </tr>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Add Routine</h5>
        ...
        <div class="modal-body">
            <div class="iq-card">
                <div class="iq-card-body">
                   <form  method="POST" action="{{ route('classRoutine.store')}}" id="myForm" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                      ...
                      <div class="form-row">
                         ...
                         <div class="col-md-12 mb-3">
                            <label for="validationTooltipUsername">Upload Pdf</label>
                            <input type="file" class="form-control" name="documentFile" id="validationTooltipUsername" >
                         </div>
                      </div>
                      {{-- <div class="form-row">
                      ...
                      <div class="form-row">
                         ...
                         <div class="col-md-12 mb-3">
                            ...
                            <input type="time" class="form-control" name="examTime" id="validationTooltipUsername" >
                         </div>
